...
<body>
    ...
    <nav>
        ...
        <ul>
        		<c:url var="alienAgeCalculator" value="/alienAgeInput"/>
            <li><a href="${alienAgeCalculator}">Alien Age</a></li>
            
            <c:url var="alienWeightCalculator" value="/alienWeightInput"/>
            <li><a href="${alienWeightCalculator}">Alien Weight</a></li>
            
            <c:url var="alienDriveTimeCalculator" value="/alienDriveTimeInput"/>
            <li><a href="${alienDriveTimeCalculator}">Drive Time</a></li>      
            
            <c:url var="alienForum" value="/alienForum"/>
            <li><a href="${alienForum}">Space Forum</a></li> 
            
            <c:url var="spaceTrivia" value="/spaceTrivia"/>
            <li><a href="${spaceTrivia}">Space Trivia</a></li> 
            
            <c:url var="spaceStore" value="/spaceStore"/>
